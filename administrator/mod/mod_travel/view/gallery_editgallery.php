...
<!--  start content-table-inner ...................................................................... START -->
	...
	<tr>
				...
				<td>
					<div class="">
						<input type="checkbox" id="editVideo" value="1" name="editImage" onclick="showUpload()"> Change Video
					</div>
					<div class="" id="activate_upload"><input class="textbox" type="file" name="upload_video"></div>
			  </td>
			</tr>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <input type="button" value="<?php echo Update;?>"  name="button" onclick="checkEditgallery();" style="cursor:pointer;width:70px;height:30px;"/>
