...
$config['skin'] = 'v2';
  ...
  if((isset($_REQUEST['cat_id']))&&(@$_REQUEST['cat_id'] != '')){ 
	...
	$partygirls = $model_partygirls_editpartygirls->getPageData($_REQUEST);
...
<!--  start content-table-inner ...................................................................... START -->
	<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_partygirls&view=editpartygirls&d=5&cat_id=<?php echo $cat_id;?>" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onsubmit="return checkAddgallery();">
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
            <tr>
                ...
                <td><input type="text"  name="gallery_title" class="textbox"  id="gallery_title" value="<?php echo $partygirls['gallery_name'];?>" maxlength="70"/></td>
            </tr>
	  ...
	  ?><?php //echo $code = $CKEditor->editor("galleryText", @$gallery['cat_content'],$config);?></td>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <input type="hidden" name="controller" value="edit_partygirls"  />
                ...
                <input type="button" value="<?php echo CANCEL;?>"   onclick="window.location.href='./index.php?mod=mod_partygirls&view=default&m=4&d=5'"  style="cursor:pointer;width:70px;height:30px;"/>
            </td>
            </tr>
        </table>
