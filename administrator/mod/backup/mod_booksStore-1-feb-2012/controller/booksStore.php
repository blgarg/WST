...
/*			echo "<pre>";
				...
				if($model_booksStore_issueBooks->issue_books($objects)){
					@header('Location:index.php?mod=mod_booksStore&view=issueBooks&m=4&s=7');}else{@header('Location:index.php?mod=mod_booksStore&view=issueBooks&m=4&r=1');
				 }
				 break;
				...
				if($model_booksStore_issueBooks->issue_emp_books($objects)){
					@header('Location:index.php?mod=mod_booksStore&view=issueBooks&m=4&s=8');}else{@header('Location:index.php?mod=mod_booksStore&view=issueBooks&m=4&r=1');
				 }
				 break;
