<?php
class gallery_controller extends JDatabaseMySQL{	
	  var $modName  = '';
	   ...
	   global $config_var;
		  ...
		  switch(@$_REQUEST['controller'])
		  {
				...
				if(isset($_FILES['image_load']) && !empty($_FILES['image_load']))
				{
					...
					$model_gallery_addNewgallery->resizeImage($url.$image_err['filename'],'320','262',$url."front_end/".$image_err['filename'],$_FILES['image_load']);
					if($image_err['error']=="")
					{
						echo "no image error"; 
