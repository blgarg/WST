			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:17%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
                      ...
                      <div style="float:left;width:5%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo QUANTITY;?></a>                        </div>
                      <div style="float:left;width:18%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo AGENTCOMMISTION."&nbsp;(".RS.")";?></a></div>  
				...
				$empname=model_reports_agents::get_employee_name($Agents[$i]['employee_id']);
				$fullname=$empname[0]['user_firstname']." ".$empname[0]['user_lastname'];
				
				$agents_commision=model_reports_agents::get_agents_commision($Agents[$i]['amt_book_id']);
				$agentscommision = $agents_commision[0]['agent_amt'];
				...
				?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;">
                           ...
                           <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:left;padding-left:1%;padding-top:12px;">
                          <?php $agentname=model_reports_agents::get_agent_title($Agents["$i"]['agent_id']);
						  echo $agentname[0]['agent_name'];
						  ?></div>
						  <div style="float:left;width:9%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:left;padding-left:1%;padding-top:12px;">
                          <?php echo $fullname; ?>
						  </div>
                          <div style="float:left;width:16%;min-height:40px;text-align:left;padding-left:1%;padding-top:12px;border-right:#CCCCCC 1px solid;"   class="breakword">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>"><!--<a href="?mod=mod_agents&view=editAgent&m=6&agent_id=<?php //echo $Agents["$i"]['agent_id'];?>" style="color:#595959;"><strong>Edit</strong></a>--><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&agent_id=<?php //echo $Agents[$i]['agent_id']; ?>" style="color:#474747;"><strong>View</strong></a>--></div>
						  ...
						  <div style="float:left;width:9%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                           ...
                           <div style="float:left;width:4%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                           ...
                           <div style="float:left;width:17%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                 ...
                 <td colspan="6" align="right">
                    <div style="width:100%;height:auto;float:right;">
                    	<div style="width:100%;height:29px;border-right:#CCCCCC 1px solid;float:right;padding-left:2%;padding-top:12px;">
                         ...
                         <a target="_blank" href="./mod/mod_reports/view/agents_report.php" style="padding-right:5px;"><?php echo Download_Report ?></a></p>
                        </div>
                       </div></td>
                </tr>
				</table>
