...
class model_reports_reprintedbook extends JDatabaseMySQL{  			
          var $qry = '';  
		  var $_result = '';             
		  var $searchCondition = ''; 
		   var $originalBanner = '';
		...
		function get_all_bookswriters()
		{
			...
			function initialize(){
				...
				$this->where = ' mgl_newbooks a,mgl_books_info b where '.$this->searchCondition.' and b.book_id=a.`book_id` order by a.`new_booksid` desc';
