	...
	function check_ordercart()
{
	...
	{
		var party_check = document.getElementById("party_category").value;
			
			if(party_check==0)
			{
				document.getElementById('content-table-inner').style.display = ''; 
				document.getElementById('err_mess').innerHTML = "Please select party category";
				document.getElementById("party_category").focus();
				return false;
			}
			else
			{
	...
	function check_academics()
	{
	var sun = document.getElementById("businessid").value;
	if(sun==0)
	{
			document.getElementById('content-table-inner').style.display = ''; 
			document.getElementById('err_mess').innerHTML = "Please select academics type.";
			document.searchForm.yearselection.focus();
			return false;
	}
	else{
...
function check_quarterly()
{
	var sun=document.getElementById("yearselection").value;
	var typeselection=document.getElementById("typeselection").value;
	if(sun==0)
	{
			document.getElementById('content-table-inner').style.display = ''; 
			document.getElementById('err_mess').innerHTML = "Please select year.";
			document.searchForm.yearselection.focus();
			return false;
	}
	...
	{
			document.getElementById('content-table-inner').style.display = ''; 
			document.getElementById('err_mess').innerHTML = "Please select type.";
			document.searchForm.typeselection.focus();
			return false;
	}
	else if(typeselection==1)
	{
		...
		{
			document.getElementById('content-table-inner').style.display = ''; 
			document.getElementById('err_mess').innerHTML = "Please select quarter.";
			document.searchForm.quarter.focus();
			return false;
		}
		else
		{
			with (window.document.searchForm){
		document.searchForm.submit();
		document.yearwise.submit();
		document.quartertype.submit();
		}
			}
	}
	else if(typeselection==2)
	{
			var selecthalf=document.getElementById("selecthalf").value;
		if(selecthalf==0)
		{
			document.getElementById('content-table-inner').style.display = ''; 
			document.getElementById('err_mess').innerHTML = "Please select half.";
			document.searchForm.selecthalf.focus();
			return false;
		}
		else
		{
...
function check_monthly()
{
	with (window.document.searchForm){
		document.searchForm.submit();
		document.yearwise.submit();
		document.monthlywise.submit();
	}
	 }
function check_yearly()
{		
document.year.wantyear.value=document.getElementById('yearwise').value;
document.searchForm.submit();
		document.yearwise.submit();
...
function check_datewise()
{
	...
	with (window.document.searchForm){
		if (isEmpty(sdate, 'Please enter start date')) {
			return false;
		}
		else if(isEmpty(edate, 'Please enter end date')) {
			return false;
		}
