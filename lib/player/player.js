      ...
      function constructUrl(baseUrl) {
        ...
        return baseUrl + 'apiplayer?version=3&video_id=u1zgFlCw8Aw&' +
            argsString;
      }
...
//      }
      ...
      function updateytplayerInfo() {
        ...
        updateHTML('videoduration', secondsToTime(getDuration()));
        updateHTML('videotime1', secondsToTime(getCurrentTime()));
		updateHTML('videotime2', secondsToTime(getCurrentTime()));
