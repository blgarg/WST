...
$string='<table border="1" cellpadding="2" cellspacing="2" >
 <tr nobr="true" style="background-color:#E8E8E4;" align="center">
  <th width="100px;">'.PERSONNAME.'</th>
  <th width="100px;">'.EMPNAME.'</th>
  <th width="50px;">'.GIFTORDERNUMBER.'</th>
  <th width="40px;">'.QUANTITY.'</th>
  <th width="50px;">'.DATE.'</th>
  <th  width="50px;">'.YEAR.'</th>
  <th  width="120px;">'.EMPLOYEENAME.'</th>
...
while($row = mysql_fetch_array($user_query))
{
$query = "SELECT user_firstname,user_lastname FROM mgl_users where user_id=" . $row['user_id'];	
