...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
		$title=HARYANAGRANTHACADEMY."(".SALEREPORT.")";
...
$string='<table border="1" cellpadding="2" cellspacing="2" >
 <tr nobr="true" style="background-color:#E8E8E4;" align="center">
  <th width="150px;"><b>('.ORDERNUMBER.')</b>&nbsp;'.PARTYNAME.'&nbsp;/&nbsp;'.ACADEMY.'&nbsp;/&nbsp;'.THIRDPERSON.'</th>
  <th width="80px;">'.EMPNAME.'</th>
  <th width="50px;">'.DATE.'</th>
  <th width="80px;">'.AGENTSCOMMISION.'</th>
  <th width="80px;">'.TOTALAMOUNT.'&nbsp;('.RS.')</th>
  <th width="100px;">'.AGENTNAME.'</th>
  <th  width="80px;">'.DISCOUNT.'&nbsp;('.RS.')</th>
...
$comm_query = "SELECT agents_commision FROM mgl_agents where agent_id=". $row['agent_id'];	
$comm_execute = mysql_query($comm_query);
$comm_data = mysql_fetch_array($comm_execute);
$commision = $comm_data['agents_commision'];
if($row['party_id']!=0){
