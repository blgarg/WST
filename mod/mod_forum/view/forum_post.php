...
<div class="body_wrapper">
  <div id="breadcrumb" class="breadcrumb">
    <ul class="floatcontainer">
     ...
     <li class="navbit"><a href="<?php echo $config_var->WEB_URL?>?mod=mod_forum&view=detail&id=<?php echo $_REQUEST['id'];?>&sub_cat=<?php echo $_REQUEST['sub_cat'];?>"><?php echo ucfirst($getSubCatById[0]['sub_cat_name']);?></a></li>
	 <li class="navbit lastnavbit"><a href="<?php echo $config_var->WEB_URL?>?mod=mod_forum&view=showthread&id=<?php echo $_REQUEST['id'];?>&sub_cat=<?php echo $_REQUEST['sub_cat'];?>&topic_id=<?php echo $_REQUEST['topic_id'];?>"><?php echo ucfirst($getTopicById[0]['topic_title']);?></a></li> 
    </ul>
    <hr>
  </div>
  ...
  <div class="bar-guide-con">
            	<div class="b-guide-hdr" style="float:left; ">
                	 Forum: <span class="forumtitle"><?php echo ucfirst($getTopicById[0]['topic_title']);?></span>
                   
                </div>
                <div class="bar-guide-txt">
                
                	<form action="./?mod=mod_forum&view=post&id=<?php echo $_REQUEST['id'];?>&sub_cat=<?php echo $_REQUEST['sub_cat'];?>&topic_id=<?php echo $_REQUEST['topic_id'];?>" onsubmit=" return checkAddCategory();" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  style="float:right;"  >
    <table border="0" width="100%" cellpadding="1" cellspacing="1">
	<tr valign="top">
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
            <tr>
                <th width="153" valign="top">Post Title<span class="red">*</span> :</th>
            ...
            <tr>
              <th valign="top"> Post <?php echo DESCRIPTION;?>:</th>
                <td><?php
