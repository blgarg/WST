                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;border-right:#CCCCCC 1px solid;">
                        ...
                        <div style="float:left;width:15%;solid;min-height:40px;padding-top:12px;padding-left:10px;">
                           <a href="?mod=mod_bar&view=editbar&m=4&cat_id=<?php echo $bar_details["$i"]['id'];?>" title="Edit" style="color:#595959;"><strong><?php echo EDIT;?></strong></a>&nbsp;<a title="Gallery" href="?mod=mod_bar&view=barGallery&d=6&id=<?php echo $bar_details["$i"]['id'];?>"><img src="<?php echo $config_var->ADMIN_TPL_URL?>images/dashboard/imagegallery.png" height="35" width="45"></a>
						   &nbsp;
						   <a title="Bar Guide Map" href="?mod=mod_bar&view=addMap&id=<?php echo $bar_details["$i"]['id'];?>"><strong>Add Map</strong></a>
						   </div>
