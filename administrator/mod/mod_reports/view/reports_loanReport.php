...
.DOBclass
{
	...
	// alert(value);
	 if(value==1)
	 {
	 var type="loan_date_wise";
	 }
	 if(value==2)
	 {
	 var type="loan_year_wise";
	 }
	 if(value==3)
	 {
	 var type="loan_academic_Wise";
	 }
	 if(value==4)
	 {
		var type = "loan_party_wise";
	 }
	 var url="mod/mod_reports/ajax/_call_ajax.php?ajax_call_method="+type;
	var obj
	 try
    ...
    <tr>
      ...
      <td>&nbsp;</td>
			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                        ...
                        <div style="float:left;width:9%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo PENDINGPAYMENT;?></a>                        </div>
			...
			//echo "<pre>";print_r($Books); die;
				...
				$empname=model_reports_loanReport::get_employee_name($Books[$i]['employee_id']);
			...
			$str = " select * from mgl_amt_sell_books as a,mgl_sell_books as b where a.amt_book_id=b.sell_amt_id and ".$this->searchCondition." and a.payment_type ='2'";
				...
				?>
                         ...
                         <a target="_blank" href="./mod/mod_reports/view/loan_report.php?str=<?php echo $str;?>&acapar=<?php echo @$_REQUEST['acapar']; ?>&biztype=<?php echo @$_REQUEST['biztype']; ?>" style="padding-right:5px;"><?php echo Download_Report ?></a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
