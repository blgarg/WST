...
{
$booksStore_addNewBook=new model_booksStore_editBook();
...
<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_booksStore&view=editBook&m=6&book_id=<?php echo $_REQUEST['book_id'];?>" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onSubmit="return checkAddbook();" >
   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
              ...
              <td><label>
                <input name="royality" <?php if($books_particular_data[0]['want_royality']==1) echo "checked";?> type="checkbox" id="royality" value="1" onclick="hide_unhide('royality','#hide-unhide')" />
              </label></td>
            </tr>
               <tr id="hide-unhide">
                 <th valign="top">&nbsp;</th>
            ...
            <tr>
              <th valign="top">Book Price<span class="red">*</span> :</th>
              <td><input type="text"  name="sell_price" value="<?php echo $books_particular_data[0]['book_price']; ?>"  id="sell_price" maxlength="50" class="textbox" onkeyup="isPrice(document.getElementById('sell_price'), 'Numbers Only Please');"/></td>
            </tr>
               <tr>
            ...
            <tr>
              ...
              <td><input type="text" disabled="disabled" name="quantity" value="<?php echo $books_particular_data[0]['quantities']; ?>"  id="quantity" maxlength="50" class="textbox" style="width:25%;"/>&nbsp;
               ...
               <tr>
                 <th valign="top">&nbsp;</th>
                 <td><span id="add_quantity" style="display:none;"><b>Add values for increase quantity:</b> <input type="text" name="quantity_add" value=""  id="quantity_add" maxlength="50" class="textbox" style="width:25%;" onkeyup="isNumeric(document.getElementById('quantity_add'), 'Numbers Only Please');" /></span><span id="minus quantity" style="display:none;"><b>Add values for decrease quantity:</b> <input type="text" name="quantity_decrease" value=""  id="quantity_decrease" maxlength="50" class="textbox" style="width:25%;" onkeyup="isNumeric(document.getElementById('quantity_decrease'), 'Numbers Only Please');" /></span></td>
               </tr>
        ...
        <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <input type="hidden" name="controller" value="edit_book_info"  />
                ...
                <input type="button" value="" class="form-submit"  name="button" onclick="checkeditbook();" style="cursor:pointer;"/>
