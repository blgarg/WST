 ...
 ?>
        ...
        <div id="content-table-inner">
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./index.php?mod=mod_Forum&view=default&d=1&type=forum" name="mainform" method="post" >
				...
				$getCatName=$model->getCatName($Categories["$i"]['topic_cat']);
				$getSubCatName=$model->getSubCatName($Categories["$i"]['topic_subcat']);
				$gettopic_image=$model->gettopic_image($Categories["$i"]['topic_id']);
				$gettopic_post=$model->gettopic_post($Categories["$i"]['topic_id']);
				...
				?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;border-right:#CCCCCC 1px solid;">
                        ...
                        <input  type="checkbox" name="cat_id[]" id="cat_id" value="<?php echo $Categories["$i"]['topic_id'];?>" />
                        </div>
						<div style="float:left;width:29%;min-height:40px;text-align:left;padding-left:1%;padding-top:auto;border-right:#CCCCCC 1px solid;"  onmouseover="displayOverLay(<?php echo $i; ?>);" onmouseout="hideOverLay(<?php echo $i; ?>);" class="breakword">
                        
                        <div style="float:left;width:98%;min-height:40px; padding-top:12px;text-align:center;">
							<?php  echo $Categories["$i"]['topic_title'];?></div>
							</div>  
					    <div style="float:left;width:13%;min-height:40px; padding-top:12px;text-align:center; border-right:#CCCCCC 1px solid;">
						 ...
						 <div style="float:left;width:15%;min-height:40px; padding-top:12px;text-align:center; border-right:#CCCCCC 1px solid;">
                            <table width="100%" border="0" style="border:none;">
								  <tr>
									<td style="border:none;"><strong><?php echo count($gettopic_image);?></strong> Photos</td>
								</tr>
								  <tr>
									<td style="border:none;"><strong><?php echo count($gettopic_post);?></strong> Reports</td>
								</tr>
							</table>
                        </div>   
                        ...
                        <div style="float:left;width:10%;solid;min-height:40px;text-align:center;padding-top:12px;">
                           <a href="?mod=mod_forum&view=editForum&m=4&topic_id=<?php echo $Categories["$i"]['topic_id'];?>" title="Edit" style="color:#595959;"><strong><?php echo EDIT;?></strong></a></div>
