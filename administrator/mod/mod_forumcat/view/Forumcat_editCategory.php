...
$config['skin'] = 'v2';
  ...
  if((isset($_REQUEST['cat_id']))&&(@$_REQUEST['cat_id'] != '')){ 
								 ...
								 $CatDb_OB->sql = "SELECT * FROM forum_categories WHERE cat_id = '$cat_id'";	
						 		 $CatDb_OB->query();
...
<!--  start content-table-inner ...................................................................... START -->
	<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_forumcat&view=editCategory&d=2&type=forum&cat_id=<?php echo $cat_id;?>" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onsubmit="return checkAddCategory();">
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
            <tr>
                ...
                <td><input type="text"  name="category_title" class="textbox"  id="category_title" value="<?php echo $Category['cat_name'];?>" maxlength="70"/></td>
            </tr>
