   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
              <tr>
                ...
                <td><span id="second"><select name="party" id="party" class="selectbox" style="padding:4px 0 0 6px;">
                  ...
                  <?php
				   ...
				   {
				   ?>
                  <option value="<?php echo $businesss[$i]['parties_id'];?>" <?php if($businesss[$i]['parties_id']==$books_particular_data[0]['party_id']) echo "selected"; ?>><?php echo $businesss[$i]['business_title'];?></option>
                  <?php
				   }
				   ?>
            ...
            <tr>
              ...
              <td><input type="text"  name="book_price" value="<?php echo $books_particular_data[0]['party_price']; ?>"  id="book_price" maxlength="50" class="textbox" onkeyup="isPrice(document.getElementById('book_price'), 'Numbers Only Please');" /></td>
            </tr>
            <tr>
              <th valign="top">Selling Price<span class="red">*</span> :</th>
              <td><input type="text"  name="sell_price" value="<?php echo $books_particular_data[0]['book_price']; ?>"  id="sell" maxlength="50" class="textbox" onkeyup="isPrice(document.getElementById('sell'), 'Numbers Only Please');"/></td>
            </tr>
               <tr>
            ...
            <tr>
              ...
              <td><input type="text" disabled="disabled" name="quantity" value="<?php echo $books_particular_data[0]['quantities']; ?>"  id="quantity" maxlength="50" class="textbox" style="width:25%;"/>&nbsp;
               ...
               <tr>
                 <th valign="top">&nbsp;</th>
                 <td><span id="add_quantity" style="display:none;"><b>Add values for increase quantity:</b> <input type="text" name="quantity_add" value=""  id="quantity_add" maxlength="50" class="textbox" onkeyup="isNumeric(document.getElementById('quantity_add'), 'Numbers Only Please');" style="width:25%;"/></span><span id="minus quantity" style="display:none;"><b>Add values for decrease quantity:</b> <input type="text" name="quantity_decrease" value="" onkeyup="isNumeric(document.getElementById('quantity_decrease'), 'Numbers Only Please');"  id="quantity_decrease" maxlength="50" class="textbox" style="width:25%;"/></span></td>
               </tr>
