...
function ajax_showTooltip(e,externalFile,inputObj)
{
   ...
   if(document.all)e = event;
	...
	if(!ajax_tooltipObj)	/* Tooltip div not created yet ? */
	{
		...
		buttonDiv.style.cssText = 'position:relative;bottom:20px;left:260px;text-align:right;font-size:0.8em;height:15px;z-index:10000000;width:50px;';
		buttonDiv.innerHTML = '<a href="#" onclick="ajax_hideTooltip();return false" id="tooltipClose"><img src="./template/system/images/24.png"></a>';
