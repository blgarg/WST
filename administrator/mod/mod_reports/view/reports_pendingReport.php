      ...
      <td>&nbsp;</td>
			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:13%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo DISCOUNT;?>&nbsp;(Rs)</a>                        </div>
            ...
            <!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
                       ...
                       <div style="float:left;width:7%;min-height:40px;text-align:center">
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo View_detail ; ?></a>                        </div>
                  </div></td>
                </tr>
				<?php 
				...
				$empname=model_reports_pendingReport::get_employee_name($Books[$i]['employee_id']);
				...
				?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;">
                        ...
                        <a href="./?mod=mod_reports&view=detail&sell_id=<?php echo base64_encode($Books["$i"]['amt_book_id']); ?>&m=6&d=12&employee_id=<?php echo $Books[$i]['employee_id'] ;?>"><img src="<?php echo $config_var->ADMIN_TPL_URL;?>images/detail.png" /></a>
                        </div>
                       </div></td>
                </tr>
				...
				$str = ' select * from mgl_amt_sell_books a,mgl_sell_books b where a.amt_book_id=b.sell_amt_id and a.pending_payment!=0 and '.$this->searchCondition.'  group by b.sell_amt_id order by a.academy_id,a.party_id asc';
                         ?>
                         <a target="_blank" href="./mod/mod_reports/view/pending_report.php?str=<?php echo $str;?>" style="padding-right:5px;"><?php echo Download_Report ?></a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
