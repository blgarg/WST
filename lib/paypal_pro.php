...
function PPHttpPost($methodName_, $nvpStr_) {
	...
	$API_UserName = urlencode('navjot_1357561424_biz_api1.gmail.com');
		$API_Password = urlencode('1357561450');
		$API_Signature = urlencode('AFcWxV21C7fd0v3bYYYRCpSSRl31AXmsYvpkmjYHNEDM84Ldy5ZHo40Y');
