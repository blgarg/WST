...
$country_list=model_gallery_addNewgallery::countryList();
$category_list=model_gallery_addNewgallery::categoryList();
//echo "<pre>"; print_r($country_list); die;
?>
<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_gallery&view=addNewgallery&m=4" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onSubmit="return checkAddgallery();" >
   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        ...
        <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <input type="hidden" name="controller" value="add_new_gallery"  />
             ...
             <input type="button" value="<?php echo SAVE;?>"  title="Save" name="button" onclick="checkAddgallery();" style="cursor:pointer;width:70px;height:30px;"/>
                <input type="button" value="<?php echo CANCEL;?>" title="Cancel" onclick="window.location.href='./?mod=mod_gallery&view=default&m=4'"  style="cursor:pointer;width:70px;height:30px;"/>          </td>
            </tr>
        </table>
  	<!-- end id-form  -->
</td>
