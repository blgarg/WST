 ...
 ?>
        ...
        <div id="content-table-inner">
			...
			<form name="searchForm" id="searchForm" method="post" >
                    ...
                    <input type="hidden" name="mod" value="mod_forumsubcat"  />
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./index.php?mod=mod_forumcat&view=default&d=2&type=forum" name="mainform" method="post" >
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                        ...
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Sub Category Title</a>
                        </div>
				...
				?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;border-right:#CCCCCC 1px solid;">
                        ...
                        <input  type="checkbox" name="cat_id[]" id="cat_id" value="<?php echo $Categories["$i"]['sub_cat_id'];?>" />
                        </div>
                        ...
                        <div style="float:left;width:98%;min-height:29px;text-align:left;padding-left:1%;">
							<?php  echo $Categories["$i"]['sub_cat_name'];?>   </div>		
                       </div>  
					   <div style="float:left;width:30%;min-height:40px; padding-top:12px;text-align:center; border-right:#CCCCCC 1px solid;">
							<?php  echo $getCatName[0]['cat_name'];?>   </div>		
                        ...
                        <div style="float:left;width:24%;solid;min-height:40px;text-align:center;padding-top:12px;">
                           <a href="?mod=mod_forumsubcat&view=editCategory&d=3&type=forum&cat_id=<?php echo $Categories["$i"]['sub_cat_id'];?>" title="Edit" style="color:#595959;"><strong><?php echo EDIT;?></strong></a></div>
