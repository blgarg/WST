...
global $model;
global $DataSet;
$your_cart_update=new model_booksStore_seeCart();
	...
	if(elem.value.match(numericExpression)){
        ...
        <div id="content-table-inner">
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./?mod=mod_booksStore&view=seeCart&m=2" name="mainform" method="post" >
                ...
                <td colspan="6" align="left">
                   ...
                   <!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
					...
					{
					$your_cart=new model_booksStore_seeCart();
					$max=count($_SESSION['cart']);
					for($i=0;$i<$max;$i++){
					$pid=$_SESSION['cart'][$i]['productid'];
                 ...
                 <td colspan="6">
                    <div style="width:100%;height:auto;float:left;">
					  ...
					  <div style="float:left;width:25%;min-height:65px;text-align:left;padding-left:1%;padding-top:12px;border-right:#CCCCCC 1px solid;"  onmouseover="displayOverLay(<?php echo $i; ?>);" onmouseout="hideOverLay(<?php echo $i; ?>);" class="breakword">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>">&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:del(<?php echo $Books['book_id'];?>)" style="color:#474747;"><strong>Remove</strong></a></div>
                        </div>  
                           ...
                           <div style="float:left;width:13%;min-height:65px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                             <label>
                             <input type="text" maxlength="5" name="product<?php echo $pid;?>" value="<?php echo $q;?>" id="product<?php echo $pid;?>"  size="3" onkeyup="isNumeric(document.getElementById('product<?php echo $pid;?>'), 'Numbers Only Please');" />							<input type="hidden" name="avai_qty<?php echo $pid;?>" value="<?php echo $Books['quantities'];?>" />
                             </label>
                           </div>
				...
				?>
                 <tr>
                  ...
                  <tr>
                   <td colspan="6" style="float:right;border:none;font-size:17px;padding:5px 26px 0px 0px;"><input type="button" value="Sell books" onclick="window.location.href='./?mod=mod_booksStore&view=sell_books&m=2'" style="cursor:pointer;" /></td>
                 </tr>
