...
.DOBclass
{
	...
	obj.onreadystatechange=function()
      ...
      function get_busingesss(value)
	 {
	  if(value==1)
	 {
	 var type="date_wise_issue";
	 }
	 if(value==2)
	 {
	 var type="year_wise_issue";
	 }
	 var url="mod/mod_reports/ajax/_call_ajax.php?ajax_call_method="+type;
	var obj
	 try
	...
	obj.onreadystatechange=function()
      ...
      <td>&nbsp;</td>
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./index.php?mod=mod_reports&view=issuebook&m=6&d=13" name="mainform" method="post" >
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                        ...
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Issue Employee Name</a>                        </div>
                           <div style="float:left;width:23%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Issue order number</a>                        </div>
                      <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Total Books</a>                        </div>
                      <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Issue Date</a></div>
                      <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Issue Year</a>                        </div>
...
<!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
                       ...
                       <div style="float:left;width:14%;min-height:40px;text-align:center">
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Enter Employee</a>                        </div>
                  </div></td>
                </tr>
				<?php 
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;">
                        ...
                        <div style="float:left;width:98%;min-height:29px;text-align:left;padding-left:1%;">
							<?php $author=model_reports_issuebook::get_all_empname($Books["$i"]['issue_user_id']);
                        ...
                        <!--<div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php //echo $i;?>"><a href="?mod=mod_agents&view=editAgent&m=6&agent_id=<?php //echo $Books["$i"]['agent_id'];?>" style="color:#595959;"><strong>Edit</strong></a><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&agent_id=<?php //echo $Books[$i]['agent_id']; ?>" style="color:#474747;"><strong>View</strong></a></div>-->
                           ...
                           <?php $totalbooks=model_reports_issuebook::get_totalbooks($Books["$i"]['amt_id']);
							 echo $totalbooks[0]['totalbooks'];
						   ?></div>
                           <div style="float:left;width:13%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                           <?php echo $Books["$i"]['amt_date'];?></div>
                           <div style="float:left;width:13%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                           <?php echo $Books["$i"]['amt_year'];?></div>
                        ...
                        <?php $author=model_reports_issuebook::get_all_empname($Books["$i"]['emp_issue_id']);
							if($author[0]['user_display_name']!="") {
							 echo $author[0]['user_display_name'];
							 }
							 else
				...
				$secondhalf_end=$year1."-12-31";
					if(isset($_REQUEST['typeselection']) && @$_REQUEST['typeselection']==3){
						$this->searchCondition .= " amt_year='".@$_REQUEST['yearselection']."' ";
					}
					else if(isset($_REQUEST['typeselection']) && @$_REQUEST['typeselection']==1){
								if(isset($_REQUEST['quarter']) && @$_REQUEST['quarter']==1){
								$this->searchCondition .= " amt_date>='".$quater_first."' and amt_date<='".$endquater_first."' ";
						 }
						 else if(isset($_REQUEST['quarter']) && @$_REQUEST['quarter']==2){
								$this->searchCondition .= " amt_date>='".$quater_second."' and amt_date<='".$endquater_second."' ";
						 }
						  else if(isset($_REQUEST['quarter']) && @$_REQUEST['quarter']==3){
								$this->searchCondition .= " amt_date>='".$quater_third."' and amt_date<='".$endquater_third."' ";
						 }
						  else if(isset($_REQUEST['quarter']) && @$_REQUEST['quarter']==4){
								$this->searchCondition .= " amt_date>='".$quater_fourth."' and amt_date<='".$endquater_fourth."' ";
						 }
					}
				else if(isset($_REQUEST['typeselection']) && @$_REQUEST['typeselection']==2){
						if(isset($_REQUEST['selecthalf']) && @$_REQUEST['selecthalf']==1){
								$this->searchCondition .= " amt_date>='".$firsthalf_start."' and amt_date<='".$firsthalf_end."' ";
						 }
						 else if(isset($_REQUEST['selecthalf']) && @$_REQUEST['selecthalf']==2){
								$this->searchCondition .= " amt_date>='".$secondhalf_start."' and amt_date<='".$secondhalf_end."' ";
						 }
						  
				 }	
				}
				 $str = ' select * from mgl_total_amount a,mgl_issue_book b,mgl_users as c where a.amt_id=b.issue_foregin_id and c.user_id=a.emp_issue_id and '.$this->searchCondition.'  group by b.issue_foregin_id order by a.issue_user_id asc';
                         ?>
                         <a target="_blank" href="./mod/mod_reports/view/issuebook_report.php?str=<?php echo $str;?>" style="padding-right:5px;">Click here to download report</a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
                 ...
                 <td colspan="6" align="left">
                    <div style="width:100%;height:auto;float:left;">
                    	<div style="width:100%;height:59px;border-right:#CCCCCC 1px solid;float:left;padding-left:2%;padding-top:12px;">
                         <p align="center" style="color:#000;font-size:22px;font-weight:bold;">No Report</p>
                        </div>
                       </div></td>
                </tr>
                <?php } 
