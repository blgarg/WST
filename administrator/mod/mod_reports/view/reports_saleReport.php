...
.DOBclass
{
    ...
    <tr>
      ...
      <td id="second" style="width:600px;"></td>
      ...
      <td>&nbsp;</td>
			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:9%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo EMPNAME;?></a>                        </div>
					  <div style="float:left;width:10%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo DATE;?></a>                        </div>
					  <div style="float:left;width:10%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo AGENTSCOMMISION;?></a>                        </div>
					  <div style="float:left;width:10%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo TOTALAMOUNT;?></a>                        </div>
                      <div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo AGENTNAME;?></a></div>
                      <div style="float:left;width:10%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo DISCOUNT;?>&nbsp;(%)</a>                        </div>
            ...
            <!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
                       ...
                       <div style="float:left;width:7%;min-height:40px;text-align:center">
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo VIEWINDETAIL;?></a>                        </div>
                  </div></td>
                </tr>
				<?php 
			...
			$empname=model_reports_saleReport::get_employee_name($Books[$i]['employee_id']);
			$fullname=$empname[0]['user_firstname']." ".$empname[0]['user_lastname'];
			
			$agents_commision=model_reports_saleReport::get_agents_commision($Books[$i]['agent_id']);
			$agentscommision = $agents_commision[0]['agents_commision'];
				?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;;float:left;">
                        ...
                        <div style="float:left;width:98%;min-height:41px;text-align:left;padding-left:1%;">
							...
							$partytitle=model_reports_saleReport::get_particular_party($Books["$i"]['party_id']);
							echo "<b>".$Books["$i"]['amt_book_id'].".</b>&nbsp;".$partytitle[0]['party_title']."&nbsp;<b>(".PARTYNAME.")</b>";
							}
							else if($Books["$i"]['academy_id']!=0){
							$partytitle=model_reports_saleReport::get_party_title($Books["$i"]['academy_id']);
							echo "<b>".$Books["$i"]['amt_book_id'].".</b>&nbsp;".$partytitle[0]['business_title']."&nbsp;<b>(".ACADEMY.")</b>";
							}
							else {
							$partytitle=model_reports_saleReport::get_third_person($Books["$i"]['amt_book_id']);
                        ...
                        <!--<div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php //echo $i;?>"><a href="?mod=mod_agents&view=editAgent&m=6&agent_id=<?php //echo $Books["$i"]['agent_id'];?>" style="color:#595959;"><strong>Edit</strong></a><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&agent_id=<?php //echo $Books[$i]['agent_id']; ?>" style="color:#474747;"><strong>View</strong></a></div>-->
                           ...
                           <?php $agentname=model_reports_saleReport::get_particular_agentname($Books["$i"]['agent_id']);
						...
						?></div>
                         ...
                         <div style="float:left;width:6%;min-height:40px;margin-top:5px;text-align:center;padding-left:1%;padding-top:5px;">
                        <?php //echo date("Y/m/d",strtotime($Books["$i"]['createdDate']));?>
                        <?php /* if($Books["$i"]['Actions']=='1') echo 'Active'; else echo "Deactive";*/?>
                        <a href="./?mod=mod_reports&view=detail&sell_id=<?php echo base64_encode($Books["$i"]['amt_book_id']); ?>&m=6&d=12&empname=<?php echo $fullname ;?>&agentid=<?php echo $Books[$i]['agent_id'] ;?>"><img src="<?php echo $config_var->ADMIN_TPL_URL;?>images/detail.png" /></a>
                        </div>
                       </div></td>
                </tr>
				...
				$str = ' select * from mgl_amt_sell_books a,mgl_sell_books b where a.amt_book_id=b.sell_amt_id and '.$this->searchCondition.'  group by b.sell_amt_id order by a.academy_id,a.party_id asc';
                         ?>
                         <a target="_blank" href="./mod/mod_reports/view/export_report.php?str=<?php echo $str;?>" style="padding-right:5px;"><?php echo Download_Report ?></a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
