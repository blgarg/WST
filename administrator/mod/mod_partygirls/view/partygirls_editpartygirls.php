...
<!--  start content-table-inner ...................................................................... START -->
	<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_partygirls&view=editpartygirls&d=5&cat_id=<?php echo $gallery['id'];?>" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onsubmit="return checkEditgallery();">
	...
	<tr>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <input type="button" value="<?php echo CANCEL;?>"  title="Cancel" onclick="window.location.href='./index.php?mod=mod_partygirls&view=default&m=4&d=5'"  style="cursor:pointer;width:70px;height:30px;"/>
            </td>
            </tr>
        </table>
