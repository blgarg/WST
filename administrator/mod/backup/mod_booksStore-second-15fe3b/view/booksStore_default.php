				...
				for($i = 0;$i<count($Books);$i++){	?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;height:auto;float:left;">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>"><a href="?mod=mod_booksStore&view=<?php if($Books["$i"]['purchase_type']==1){ echo "editpurchaseBooks";} else {echo "editBook";}?>&m=1&book_id=<?php echo base64_encode($Books["$i"]['book_id']);?>" style="color:#595959;"><strong>Edit</strong></a><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&book_id=<?php //echo $Books[$i]['book_id']; ?>" style="color:#474747;"><strong>View</strong></a>--></div>
