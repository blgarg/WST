...
class model_booksStore_sellBooks extends JDatabaseMySQL{  			
          ...
          function __construct(  ){ 
			...
			function initialize(){
				...
				$this->adjacents = '1';
				if(isset($_REQUEST['hdnSearch']) && $_REQUEST['hdnSearch']=='hdnsearch'){
				$this->page = 'index.php?mod=mod_booksStore&view=sellBooks&m=2&d=5&creteria='.trim($_REQUEST['creteria']).'&hdnSearch='.$_REQUEST['hdnSearch']."&cmbStatus=".$_REQUEST['cmbStatus'];
				}else{
				$this->page = 'index.php?mod=mod_booksStore&view=sellBooks&m=2&d=5';
				}
				$this->pageLimit = '10';
