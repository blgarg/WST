    ...
    <?php 
	  ...
	  ?>
       <tr>
        ...
        <tr>
        <td></td>
        <td align="right"><b>Transport Cost:</b></td>
        <td align="right"><input type="text" name="transport_cost" id="transport_cost" maxlength="10" class="textbox" style="width:65%;" onkeyup="isNumeric(document.getElementById('transport_cost'), 'Numbers Only Please');get_totalprice();"  /></td>
      </tr>
      <tr>
        <td></td>
        <td align="right"><b style="padding-right:8px;">Postage Cost:</b></td>
        <td align="right"><input type="text" maxlength="10" name="postage_cost" id="postage_cost" class="textbox" style="width:65%;" onkeyup="isNumeric(document.getElementById('postage_cost'), 'Numbers Only Please');get_totalprice();"   /></td>
      </tr>
      <tr>
        <td></td>
        <td align="right"><b style="padding-right:17px;">Discount(%):</b></td>
        <td align="right"><input type="text" name="discount" id="discount" class="textbox" style="width:65%;"  onkeyup="isNumeric(document.getElementById('discount'), 'Numbers Only Please');get_totalprice();"   /></td>
      </tr>
      <tr>
        <td colspan="3" style="text-align: right; border-top: 1px solid gray; padding-top: 5px; font-size: medium;" id="price"><?php echo "<b>Rs&nbsp;".$price."</b>";?></td>
        </tr>
    </table></td>
            </tr>
            <tr>
              <th width="69" valign="top">&nbsp;</th>
              <td width="354" style="text-align:right;"><label> <input type="button" value="Generate Bill" name="button" onclick="check_sellcart();" style="cursor:pointer;width:88px;height:30px;float:right;"/></label></td>
            </tr>
                <tr>
