           ...
           <!--Bar Guide Container--> 
			...
			<?php } ?>	
                <div class="bar-guide-txt">
                	...
                	<!--Videos Row-->
                    <div class="videos-row" style="height: 178px !important;margin-left:10px !important;">
                    <?php
                    //echo"<pre>"; 
                    ...
                    if(count($DataSet['result'])>0){ ?>
						...
						?>
						<div class="video-outer" style="height: 125px !important;width: 155px !important;margin-left: 20px !important;">
                        	<div class="video" style="height: 130px !important;width: 152px !important;box-shadow:none !important;">
							
						
							<!-- <a href="<?php //echo $config_var->WEB_URL?>?mod=mod_partygirls&view=detail&s=3&id=<?php //echo$DataSet['result'][$j]['id'];?>"> -->
							<a href="<?php echo $config_var->WEB_URL?>?mod=mod_partygirls&view=fullDetail&s=3&id=<?php echo$DataSet['result'][$j]['id'];?>&img=<?php echo $DataSet['result'][$j]['image_thumbnail']; ?>">
							
								<img src="<?php echo $config_var->UPLOAD_URL;?>partygirls_images/front_end/<?php echo $DataSet['result'][$j]['image_thumbnail']; ?>" alt="" />
							</a>
							</div>
                       ...
                       <?php 
						if(($j+1)%5==0 && count($DataSet['result'])>5)
						{
							echo '</div><div class="videos-row" style="height: 178px !important;margin-left:10px !important;">';
						}
					   }
					   //end if
					   }
