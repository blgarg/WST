...
class model_Forumcat_editCategory extends JDatabaseMySQL
{  			
          var $tableName;
		  var $pageTitle;
		  ...
		  var $_result = '';     
			...
			$this->sql = "SELECT * FROM forum_categories where cat_name='". $data->categorytitle."' and cat_id !='".$data->cat_id."'"; 
			$this->query();
			...
			{	
				$this->sql = "SELECT * FROM forum_categories WHERE cat_id='".$data['cat_id']."'";
				$this->query();
			...
			function saveData($data)
			{
			  ...
			  */
				$this->qry = "UPDATE forum_categories SET
					  cat_name='".$this->categoryTitle."'
