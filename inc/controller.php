<?php
$theme_mod = isset($_GET['mod'])?$_GET['mod']:'mod_index';
$mod_view = isset($_GET['view'])?$_GET['view']:'default';
// file to be included 
$mod_path = explode("_",$theme_mod);
$template_file  =  $config_var->WEB_ROOT.'mod/'.$theme_mod."/".$mod_path[1].".php"; // modlule absolute path
