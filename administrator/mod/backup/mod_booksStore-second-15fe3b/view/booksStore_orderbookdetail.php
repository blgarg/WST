...
$config['skin'] = 'v2';
$model_booksStore_orderbookdetail = new model_booksStore_orderbookdetail();
$particular_book = $model_booksStore_orderbookdetail->getBookData($_REQUEST);
/*echo "<pre>";
...
<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_booksStore&view=orderbookdetail&book_id=<?php echo $_REQUEST['book_id'];?>&m=7" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onSubmit="return checkadd_book_cart();" >
   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
              ...
              <td><?php if($particular_book['royality_writer_id']==0){echo "N.A";} else {$writer_title=$model_booksStore_orderbookdetail->get_royalitywriter($particular_book['royality_writer_id']); echo $writer_title['writer_name'];}?></td>
            </tr>
                <tr>
              <th valign="top"> Category:</th>
              <td><?php if($particular_book['book_cat_id']==0){echo "N.A";} else {$book_title=$model_booksStore_orderbookdetail->get_book_category($particular_book['book_cat_id']); echo $book_title['cat_title'];/*$book_title['cat_title'];*/} ?></td>
            </tr>
                <tr>
        ...
        <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <input type="hidden" name="controller" value="add_book_order"  />
                <input type="hidden" name="mod" value="mod_booksStore"  />
                <input type="button" value="Add for order" name="button" onclick="checkadd_book_cart();" style="cursor:pointer;width:89px;height:30px;float:left;"/>
