	 ...
	 function tooBar(){ 
	  switch(@$_GET['view'])
	   ...
	   $this->toolBr = '<table  cellpadding="0" cellspacing="0" width="100%" border="0" >
						...
						<a href = "./?mod=mod_forumcat&view=addNewCategory&d=2&type=forum" title="Add New" >
...
/*		function addNewModel(){
		...
		function addNewCategory(){
			...
			<td align="center" width="12%" >
			<a href = "./index.php?mod=mod_forumcat&view=default&d=2&type=forum" title="Cancel">
