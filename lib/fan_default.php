...
<div class="artist_page_outer">
            ...
            <div class="fan_page">
						...
						?>
                           <script>
						    $(document).ready(function(){
							  ytVideoApp.getVideoView('<?php echo $lastVideoPlayData[0]['playId'];?>')
							});
						   </script>
                            ...
                            <div class="last_video_text_underneath"><span id="last_video_view_count"><img src="<?php echo  $config_var->WEB_TPL_URL; ?>images/loader.gif" alt="wait" width="75" height="75" /></span></div>
                        <?php }else{ ?>
                ...
                <div class="saved_playlist_outer">
                ...
                <div class="about_fan_bg" id="user_content">
                    ...
                    <div class="about_fan_bg_cen">
                        ...
                        <?php $current_Favorite_Artist_1 = $model_fan_default->getMyFavouritArtistDetail($idUser);
