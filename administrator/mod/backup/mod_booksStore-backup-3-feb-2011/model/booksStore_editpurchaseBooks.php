...
class model_booksStore_editpurchaseBooks extends JDatabaseMySQL{  			
          var $categoryTitle;
		  var $categoryText;
          ...
          function initialize(){ return ; }	
			...
			$HelperOb = new Helper();
			  ...
			  $this->book_purchase_price = @mysql_real_escape_string(stripslashes($data->book_purchase_price));
			  ...
			  $this->qry = "UPDATE mgl_books_info SET
					  business_id='".$this->business_type."',
                      party_id='".$this->party."',
					  party_price='".$this->book_purchase_price."',
                      book_cat_id='".$this->category."',
