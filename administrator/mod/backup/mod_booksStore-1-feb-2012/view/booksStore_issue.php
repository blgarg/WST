...
global $model;
global $DataSet;
$your_cart_update=new model_booksStore_issue();
 ...
 ?>
        ...
        <div id="content-table-inner">
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./?mod=mod_booksStore&view=issue&m=2" name="mainform" method="post" >
                ...
                <td colspan="6" align="left">
                   ...
                   <!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
					...
					{
					$your_cart=new model_booksStore_issue();
                 ...
                 <td colspan="6">
                    <div style="width:100%;height:auto;float:left;">
					  ...
					  <div style="float:left;width:25%;min-height:65px;text-align:left;padding-left:1%;padding-top:12px;border-right:#CCCCCC 1px solid;"  onmouseover="displayOverLay(<?php echo $i; ?>);" onmouseout="hideOverLay(<?php echo $i; ?>);" class="breakword">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>">&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:delissue(<?php echo $Books['book_id'];?>)" style="color:#474747;"><strong>Remove</strong></a></div>
                        </div>  
                           ...
                           <div style="float:left;width:13%;min-height:65px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                             <label>
                             <input type="text" maxlength="5" name="product<?php echo $pid;?>" value="<?php echo $q;?>"  size="3" />							<input type="hidden" name="avai_qty<?php echo $pid;?>" value="<?php echo $Books['quantities'];?>" />
                             </label>
                           </div>
                ...
                <tr>
                   <td colspan="6" style="float:right;border:none;font-size:17px;padding:5px 26px 0px 0px;"><input type="button" value="Issue books" onclick="window.location.href='./?mod=mod_booksStore&view=issue_type&m=4'" style="cursor:pointer;" /></td>
                 </tr>
  				<?php  } if(count($_SESSION['issue_cart']) <=0){	?>
                <tr>
                 <td colspan="6" align="left">
                    <div style="width:100%;height:auto;float:left;">
				...
				<!--  end product-table................................... -->
                 <input type="hidden" name="controller" value="clear_issue_cart" id="controller"  /> 
             </form>
			</div>
			<!--  end content-table  -->
