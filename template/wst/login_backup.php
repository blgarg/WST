         	...
         	<div class="content_innner">
                ...
                <!--SIGNUP START-->
                   <div class="signUp pB20">
                    ...
                    <form name="signUp" method="post" action="" id="site_info"/>
                    <div class="signUp_box">
                    
                    <div class="w40">Email:</div>
                     <div class="w60"><input type="text" name="email" class="text_box required" /></div>
                    <div class="w40">Paswword</div>
                     <div class="w60"><input type="password" password="password" name="password" class="text_box required" /></div>
                      <div class="w40">&nbsp;</div>
                     <div class="w60"><input type="submit" value="submit"/></div>
                    <div class="clear"></div>  
                    </div>
                   </form>
                     <div class="clear"></div>  
