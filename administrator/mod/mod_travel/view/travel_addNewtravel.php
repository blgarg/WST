   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		...
		<tr>
              ...
              <td width="558"><input type="text"  name="whours"  id="whours" maxlength="150" class="textbox"/></td>
        </tr>
		<tr>
        ...
        <tr>
            ...
            <td valign="top">
             ...
             <input type="submit" value="<?php echo SAVE;?>"  title="Save" name="button" onclick="checkAddtravel();" style="cursor:pointer;width:70px;height:30px;"/>
