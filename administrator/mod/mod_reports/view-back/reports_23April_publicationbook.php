...
.DOBclass
{
	...
	obj.onreadystatechange=function()
      ...
      function get_busingesss(value)
	 {
	  if(value==1)
	 {
	 var type="date_wise_publication";
	 }
	 if(value==2)
	 {
	 var type="year_wise_publication";
	 }
	 var url="mod/mod_reports/ajax/_call_ajax.php?ajax_call_method="+type;
	var obj
	 try
			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:23%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Publication date</a>                        </div>
                      <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Purchase Price</a>                        </div>
...
<!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
                       ...
                       <div style="float:left;width:14%;min-height:40px;text-align:center">
                        <a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Author</a>                        </div>
                  </div></td>
                </tr>
				<?php 
				...
				*/
				...
				$secondhalf_end=$year1."-12-31";
				 ...
				 $str = ' select * from mgl_books_info where '.$this->searchCondition.'  order by book_id desc';
                         ?>
                         <a target="_blank" href="./mod/mod_reports/view/publication_report.php?str=<?php echo $str;?>" style="padding-right:5px;">Click here to download report</a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
