...
function checkSettings()
{
	...
	var filter=email_str.match(/^[^0-9][a-z0-9_]+([.][a-z0-9_]+)*[@][a-z0-9]+([.][a-z0-9]+)*[.][a-z]{2,4}$/i);
	   ...
	   if(isEmpty(website_name, 'Please enter website name')){
	    return;
	   }else if (isEmpty(logo_text, 'Please enter logo text in hindi')) {
			return;
		}	
		else if (isEmpty(logo_text2, 'Please enter logo text in english')) {
			return;
		}
		...
		return false;
			...
			return;
		}else if (isEmpty(addresshindi, 'Please enter bill address in hindi')) {
			return;
		}else if (isEmpty(addressenglish, 'Please enter bill address in english')) {
			return;
		}else {
