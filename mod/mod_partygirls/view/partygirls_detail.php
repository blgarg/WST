...
if(isset($_GET['id']) && $_GET['id']!='')
{
	...
	if(is_dir($config_var->UPLOAD_ROOT."partygirls_images/".$_GET['id']))
	$images= scandir($config_var->UPLOAD_ROOT."partygirls_images/".$_GET['id']);
	else
	$images=array();
}
if(count($images)<=27){
				...
				$height = $sizes[1];
							...
							$width2=$width/4;
									...
									?>
										...
										<a href="?mod=mod_partygirls&view=fullDetail&s=3&id=<?php echo $_GET['id'];?>&img=<?php echo $images[$i];?>"><img title ="<?php echo $images[$i];?>" src="<?php echo $config_var->UPLOAD_URL."partygirls_images/".$_GET['id']."/".$images[$i];?>" class="test" width="<?php echo $width2; ?>"  /></a>
							...
							<div class="result photo-album-img" >
										<a href="?mod=mod_partygirls&view=fullDetail&s=3&id=<?php echo $_GET['id'];?>&img=<?php echo $images[$i];?>"><img title ="<?php echo $images[$i];?>" src="<?php echo $config_var->UPLOAD_URL."partygirls_images/".$_GET['id']."/thumbnails/".$images[$i];?>"   width="144" height="192" class="demo" /></a>
