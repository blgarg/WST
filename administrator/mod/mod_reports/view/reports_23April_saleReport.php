      ...
      <td>&nbsp;</td>
			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:22%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo AGENTNAME;?></a></div>
                      <div style="float:left;width:14%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;"><?php echo DISCOUNT;?>&nbsp;(%)</a>                        </div>
            ...
            <!--<div style="float:left;width:15%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center">
				...
				$str = ' select * from mgl_amt_sell_books a,mgl_sell_books b where a.amt_book_id=b.sell_amt_id and '.$this->searchCondition.'  group by b.sell_amt_id order by a.academy_id,a.party_id asc';
                         ?>
                         <a target="_blank" href="./mod/mod_reports/view/export_report.php?str=<?php echo $str;?>" style="padding-right:5px;">Click here to download report</a></p>
                        </div>
                       </div></td>
                </tr>
                <?php
