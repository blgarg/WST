...
<!--  start content-table-inner ...................................................................... START -->
	<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_users&view=editUser&m=1&user_id=<?php echo $user_id;?>" method="post" id="adddUserFrm" name="adddUserFrm" enctype="multipart/form-data" >
    ...
    width: 70px;"  name="button" onclick="checkEditUser();" style="cursor:pointer;"/>
                <input type="button" value="Cancel" title="Cancel" style="height: 30px;
    width: 70px;" onclick="window.location.href='./index.php?mod=mod_users&view=default&m=1'"  style="cursor:pointer;"/>
            </td>
            </tr>
        </table>
