	  ...
	  switch(@$_GET['view'])
	   {
		 ...
		 case 'addNewpartygirls':
		 		return $this->addNewpartygirls();
				break;
		 case 'editpartygirls':
		 		return $this->editpartygirls();
				break;	
		/*case 'editPage':
		 		return $this->addNewpartygirls();
				break;			
	   ...
	   $this->toolBr = '<table  cellpadding="0" cellspacing="0" width="100%" border="0" >
						...
						<a href = "./?mod=mod_partygirls&view=addNewpartygirls&m=3" title="Add New">
						...
						<td align="center" width="17%">
						<a href = "javascript:;" onClick="pageAction(\'featured\');" title="Activate" >
						<img src="'.$config_var->ADMIN_TPL_URL.'images/shared/activate.png" width="20" height="20" alt="" align="top" />&nbsp;<b>'.Featured.'</b></a></td>
						
						<td align="center" width="17%" valign="top">
						<a href =  "javascript:;" onClick="pageAction(\'unfeatured\');" title="Deactivate"  >
						<img src="'.$config_var->ADMIN_TPL_URL.'images/shared/deactivate.png" width="20" height="20" alt="" align="top" />&nbsp;<b>'.Unfeatured.'</b></a></td>
...
/*		function addNewModel(){
		...
		function addNewpartygirls(){
			...
			<td align="center" width="12%">
			<a href = "javascript:;" onclick="checkAddgallery();" title="Save" >
			<img src="'.$config_var->ADMIN_TPL_URL.'images/shared/save.png" width="20" height="20" alt="" align="top" />&nbsp;<b>'.SAVE.'</b></a></td>
			
			<td align="center" width="12%" >
			<a href = "./index.php?mod=mod_partygirls&view=default&d=5&m=4" title="Cancel" >
		...
		function editpartygirls(){
			...
			<td align="center" width="12%">
			<a href = "javascript:;" onclick="checkEditgallery();" title="Update" >
