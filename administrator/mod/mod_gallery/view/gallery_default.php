 ...
 ?>
        ...
        <div id="content-table-inner">
			...
			<!-- end  Grid -box........... -->
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="./index.php?mod=mod_gallery&view=default&m=4" name="mainform" method="post" >
				...
				$cat_name=model_gallery_default::get_category_name($galleries[$i]['category_id']); 
				$country_name=model_gallery_default::get_country_name($galleries[$i]['country_id']);
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;border-right:#CCCCCC 1px solid;">
                        ...
                        <div style="float:left;width:14%;solid;min-height:40px;text-align:center;padding-top:12px;">
                           <a href="?mod=mod_gallery&view=editgallery&m=4&cat_id=<?php echo $galleries["$i"]['id'];?>" title="Edit" style="color:#595959;"><strong><?php echo EDIT;?></strong></a>&nbsp;
						   <a href="?mod=mod_gallery&view=addImage&id=<?php echo $galleries["$i"]['id'];?>" title="Gallery"><img src="<?php echo $config_var->ADMIN_TPL_URL?>images/dashboard/imagegallery.png" height="35" width="45"></a></div>
