...
<div class="inner-hdr">
        ...
        <div class="inner-txt">
			<div class="videos-search">
            	<form action="?mod=mod_gallery&view=default&s=3" method="post">
				...
				<?php }?>
                    ...
                    <td width="162" valign="middle" align="right">Search By Girl Name :</td>
                ...
                <div class="bar-guide-txt">
					...
					<?php if(count($DataSet['result'])>0){?>
						...
						<div class="video-outer">
							...
							<a href="<?php echo $config_var->WEB_URL?>?mod=mod_gallery&view=detail&s=3&id=<?php echo$DataSet['result'][$j]['id'];?>">
							
							
								<img src="<?php echo $config_var->UPLOAD_URL;?>images/front_end/<?php echo $DataSet['result'][$j]['image_thumbnail']; ?>" alt="" height="162px" width="122px" />
							</a>
							</div>
					...
					if($length >= 20){
							...
							//echo $config_var->UPLOAD_URL."images/".$DataSet['result'][$j]['id'] ;
								 if(is_dir($config_var->UPLOAD_ROOT."images/".$DataSet['result'][$j]['id']))
								 {
									$countFiles = scandir($config_var->UPLOAD_ROOT."images/".$DataSet['result'][$j]['id']);
