				...
				for($i = 0;$i<count($Employees);$i++){
                 ...
                 <td colspan="6">
                    <div style="width:100%;min-height:40px;float:left;">
                        ...
                        <!--<div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php //echo $i;?>"><a href="?mod=mod_magazines&view=editMagazines&m=9&mag_id=<?php //echo $Employees["$i"]['mag_id'];?>" style="color:#595959;"><strong>Edit</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="./?mod=mod_agents&view=detail&m=5&mag_id=<?php //echo base64_encode($Employees["$i"]['mag_id']);?>" style="color:#474747;"><strong>View detail</strong></a>--><!--</div>-->
                           ...
                           <div style="float:left;width:12%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:right;padding-left:1%;padding-top:12px;">
                           	...
                           	$currtpmt = 0;
                           		...
                           		$currtpmt = $Employees["$i"]['pending_payment']-$Employees["$i"]['balance_payment']-$Employees[$i]['receivepmt'];
                           		
                           		//echo $currtpmt.'R';
                           		
                           		
                           		/* if($currtpmt>0){
                           			$a = $currtpmt = $Employees["$i"]['pending_payment']-$totalsum;
                           			$Employees["$i"]['balance_payment']-$currtpmt;
                           		} */
					 				if($currtpmt>0){
                           ...
                           <div style="float:left;width:12%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:right;padding-left:1%;padding-top:12px;">
                           		<?php 
                           			...
                           			if($Employees["$i"]['balance_payment'] != '' || $currtpmt<0){ 
                           				$a = 0-$currtpmt;
                        ...
                        <a href="?mod=mod_payments&view=recivepaymt&m=11&partiesId=<?php if(isset($Employees["$i"]['parties_id']) && $Employees["$i"]['parties_id'] != ''){ echo $Employees["$i"]['parties_id']; } if(isset($Employees["$i"]['party_id']) && $Employees["$i"]['party_id'] != ''){ echo $Employees["$i"]['party_id']; }?>&pendpmt=<?php if($currtpmt<=0){ echo "Nill"; }else{ echo $currtpmt; }?>&type=<?php echo $_REQUEST['type']; ?>" style="color:#595959;" class="info-tooltip" title="<?php echo "Click for Recive payment";?>"><strong><?php echo CLICKRECPMT;?></strong></a>
                        </div>
