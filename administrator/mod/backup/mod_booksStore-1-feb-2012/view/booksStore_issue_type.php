   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
              ...
              <td width="354"><label>
                ...
                <option value="">Select Issue book type</option>
	...
	<td align="left"> <table width="100%" border="0">
      <tr>
        ...
        <th width="16%" scope="col" align="center">Qty</th>
    ...
    <?php 
	  ...
	  ?>
       <tr>
        <th colspan="3" scope="col" align="right">Total:<?php echo "Rs".number_format($your_cart->get_order_total(),2,".",",");?></th>
        </tr>
    </table></td>
</tr>
<tr>
