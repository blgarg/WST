        ...
        <div id="content-table-inner">
			...
			<form name="searchForm" id="searchForm" method="get" >
				   ...
				   ?>
                    ...
                    <td valign="top" id="partyid"><select  class="selectbox" name="partyid"  style="width:100%;padding:3px 0 0 6px;"  ><option value="<?php base64_encode(0);?>">Select Academies</option>
                 ...
                 <td colspan="6">
                    <div style="width:100%;height:auto;float:left;">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>"><a href="?mod=mod_agents&view=editAgent&m=6&agent_id=<?php echo $BooksIssue["$i"]['agent_id'];?>" style="color:#595959;"><strong>Edit</strong></a><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&agent_id=<?php //echo $BooksIssue[$i]['agent_id']; ?>" style="color:#474747;"><strong>View</strong></a>--></div>
                           ...
                           <?php if($BooksIssue["$i"]['business_id']==0)
						   {echo "HGA Academies";}
						   else
						   { $info=new model_booksStore_issueBooks();
						   $title=$info->get_party_title($BooksIssue["$i"]['party_id']);
						   $title1=$info->get_academy_title($BooksIssue["$i"]['business_id']);
						   echo $title[0]['business_title']."&nbsp;<b>(".$title1[0]['business_cat_title'].")</b>";
						   }?></div>
