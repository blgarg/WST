			...
			<!-- end  Grid -box........... -->
                ...
                <td colspan="6" align="left">
                    <div style="margin:auto;width:100%;min-height:40px;background-color:#333333">
                      ...
                      <div style="float:left;width:12%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Purchase Price</a>                        </div>
                        <div style="float:left;width:12%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Sale Price</a>                        </div>
                        <div style="float:left;width:12%;min-height:40px;border-right:#CCCCCC 1px solid;text-align:center"><a  href="javascript:;" style="text-align:center;line-height:40px;color:#CCCCCC;font-weight:bold; text-decoration:none;cursor:text;">Quantities</a>                        </div>
				...
				for($i = 0;$i<count($Books);$i++){	?>
                 ...
                 <td colspan="6">
                    <div style="width:100%;height:auto;float:left;">
                        ...
                        <div style="width:98%;min-height:20px;display:none;margin-top:2px;float:left;" id="textOverLay_<?php echo $i;?>"><a href="?mod=mod_booksStore&view=editpurchaseBooks&m=6&book_id=<?php echo base64_encode($Books["$i"]['book_id']);?>" style="color:#595959;"><strong>Edit</strong></a><!--&nbsp;&nbsp;|&nbsp;&nbsp;<a href="./?mod=mod_cms&view=ViewModel&m=1&book_id=<?php //echo $Books[$i]['book_id']; ?>" style="color:#474747;"><strong>View</strong></a>--></div>
                           ...
                           <div style="float:left;width:11%;min-height:65px;border-right:#CCCCCC 1px solid;text-align:center;padding-left:1%;padding-top:12px;">
                         ...
                         <div style="float:left;width:9%;min-height:66px;margin-top:5px;text-align:center;padding-left:1%;padding-top:5px;">
