...
<?php
$booksStore_addNewBook=new model_booksStore_addNewBook();

?>
<div id="content-table-inner" class="Add_New_Web_Page">
	 <form action="./index.php?mod=mod_booksStore&view=addNewBook&m=3" method="post" id="adddPageFrm" name="adddPageFrm" enctype="multipart/form-data"  onSubmit="return checkAddbook();" >
   ...
   <td style="width:73%">
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        ...
        <tr>
            <th>&nbsp;</th>
            <td valign="top">
                <input type="hidden" name="controller" value="add_new_book"  />
                <input type="hidden" name="mod" value="mod_booksStore"  />
                <input type="button" value="" class="form-submit"  name="button" onclick="checkAddbook();" style="cursor:pointer;"/>
